...
class Cart_Model extends CI_Model
{
	...
	public function getCart($id_pelanggan)
	{
		if ($id_pelanggan) {
            ...
            $this->db->select('c.id_pelanggan, c.id_cart, c.id_produk, SUM(c.quantity) as quantity,p.foto_produk, l.nama_pelanggan, p.harga_produk, p.nama_produk, (SUM(c.quantity) * p.harga_produk) as total_harga');
            $this->db->from('cart c');
